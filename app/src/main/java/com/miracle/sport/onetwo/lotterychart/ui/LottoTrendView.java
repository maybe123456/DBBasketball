package com.miracle.sport.onetwo.lotterychart.ui;
...
import com.miracle.sport.onetwo.lotterychart.interfaces.ITrendChart;
...
public class LottoTrendView extends View implements OnDoubleTapListener, OnGestureListener, OnTouchListener {
    ...
    public void setScaleToMin(){
        ...
        float[] scaleRange = this.mChart.getScaleRange();
        this.mScale = scaleRange[0];
        refreshPos();
    }

    public void setMiniMode(boolean isMini){
        if (this.mChart == null) {
            return;
        }
        this.isMini = isMini;
        this.mChart.setIsMini(isMini);
    }
    ...
    public void setScrollTop(){
        ...
        if (canScroll[0]) {
            this.mNowX = scrollRange[0];
        }
        if (canScroll[1]) {
            this.mNowY = scrollRange[2];
        }
        invalidate();
    }
