...
import com.miracle.sport.schedule.view.TabItem;
...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTabStrip.setSelectedIndicatorPaddingBottom(
                a.getDimensionPixelSize(R.styleable.TabLayout_tabPaddingBottom, 0));
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        void setSelectedIndicatorHeight(int height) {
            if (mSelectedIndicatorHeight != height) {
                ...
                mRacRadius = mSelectedIndicatorHeight / 2;
                ViewCompat.postInvalidateOnAnimation(this);
            }
        }

        void setSelectedIndicatorPaddingBottom(int padding) {
            if (mSelectedIndicatorPaddingBottom != padding) {
                mSelectedIndicatorPaddingBottom = padding;
                ViewCompat.postInvalidateOnAnimation(this);
            }
        }
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                canvas.drawRect(mIndicatorLeft + mRacRadius, getHeight() - mSelectedIndicatorHeight - mSelectedIndicatorPaddingBottom,
                        mIndicatorRight - mRacRadius, getHeight() - mSelectedIndicatorPaddingBottom, mSelectedIndicatorPaint);
                canvas.drawCircle(mIndicatorLeft + mRacRadius,getHeight() - mRacRadius - mSelectedIndicatorPaddingBottom , mRacRadius, mSelectedIndicatorPaint);
                canvas.drawCircle(mIndicatorRight - mRacRadius,getHeight() - mRacRadius - mSelectedIndicatorPaddingBottom , mRacRadius, mSelectedIndicatorPaint);
            }
        }
    }
