package com.miracle.sport.home.spannable;
...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = App.getApp().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = App.getApp().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
