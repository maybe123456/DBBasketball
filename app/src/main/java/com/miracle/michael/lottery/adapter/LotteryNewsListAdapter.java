...
public class LotteryNewsListAdapter extends RecyclerViewAdapter<LotteryNewsListBean> {
    private Context context;

    public LotteryNewsListAdapter(Context context) {
        super(R.layout.item_football);
        this.context = context;
    }

    @Override
    protected void convert(BaseViewHolder helper, LotteryNewsListBean item) {
