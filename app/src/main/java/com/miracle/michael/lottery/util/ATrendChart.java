package com.miracle.michael.lottery.util;
...
public abstract class ATrendChart implements ITrendChart {
    ...
    protected LotteryTrendView mTrendView;
    ...
    public ATrendChart(Context context, LotteryTrendView lottoTrendView) {
        this.mTrendView = lottoTrendView;
        LotteryTrendView.setHardwareAccelerated(lottoTrendView, false);
