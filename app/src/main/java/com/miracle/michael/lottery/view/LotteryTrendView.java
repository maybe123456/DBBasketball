package com.miracle.michael.lottery.view;
...
import com.miracle.michael.lottery.util.ITrendChart;


public class LotteryTrendView extends View implements OnDoubleTapListener, OnGestureListener, OnTouchListener {
