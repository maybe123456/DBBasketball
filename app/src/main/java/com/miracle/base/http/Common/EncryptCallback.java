 ...
 */
package com.miracle.base.http.Common;
...
//        params.put("timestamp", System.currentTimeMillis());
        params.put("appid", App.getApp().getPackageName());
//        params.put("userid", SharePreferenceManager.getUserId(App.getContext()));
...
//
//        sign = RSAUtils.encryptByPulbicKey(sign,RSAUtils.PUCLIC_KEY);
