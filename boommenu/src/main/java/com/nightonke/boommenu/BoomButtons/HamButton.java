...
//        if (rotateImage) rotateViews.add(image);
    ...
    public static class Builder extends BoomButtonWithTextBuilder<Builder> {
        ...
        /**
         * Whether the ham-button contains a sub inner_tv-view.
         *
         * @param containsSubText contains a sub inner_tv-view or not
         * @return the builder
         */
        ...
        /**
         * Set the sub-inner_tv resource when boom-button is at normal-state.
         * <br><br>
         * <STRONG>Synchronicity:</STRONG> If the boom-button existed,
         * then synchronize this change to boom-button.
         *
         * @param subNormalTextRes sub-inner_tv resource
         * @return the builder
         */
        ...
        /**
         * Set the sub-inner_tv when boom-button is at highlighted-state.
         * <br><br>
         * <STRONG>Synchronicity:</STRONG> If the boom-button existed,
         * then synchronize this change to boom-button.
         *
         * @param subHighlightedText sub-inner_tv
         * @return the builder
         */
        ...
        /**
         * Set the sub-inner_tv resource when boom-button is at highlighted-state.
         * <br><br>
         * <STRONG>Synchronicity:</STRONG> If the boom-button existed,
         * then synchronize this change to boom-button.
         *
         * @param subHighlightedTextRes sub-inner_tv resource
         * @return the builder
         */
        ...
        /**
         * Set the sub-inner_tv when boom-button is at unable-state.
         * <br><br>
         * <STRONG>Synchronicity:</STRONG> If the boom-button existed,
         * then synchronize this change to boom-button.
         *
         * @param subUnableText sub-inner_tv
         * @return the builder
         */
        ...
        /**
         * Set the sub-inner_tv resource when boom-button is at unable-state.
         * <br><br>
         * <STRONG>Synchronicity:</STRONG> If the boom-button existed,
         * then synchronize this change to boom-button.
         *
         * @param subUnableTextRes sub-inner_tv resource
         * @return the builder
         */
        ...
        /**
         * Set the color of sub-inner_tv when boom-button is at normal-state.
         * <br><br>
         * <STRONG>Synchronicity:</STRONG> If the boom-button existed,
         * then synchronize this change to boom-button.
         *
         * @param subNormalTextColor color of sub-inner_tv
         * @return the builder
         */
         ...
         * then synchronize this change to boom-button.
         *
         * @param subNormalTextColorRes color resource of sub-inner_tv
         * @return the builder
         */
        ...
        /**
         * Set the color of sub-inner_tv when boom-button is at highlighted-state.
         * <br><br>
         * <STRONG>Synchronicity:</STRONG> If the boom-button existed,
         * then synchronize this change to boom-button.
         *
         * @param subHighlightedTextColor color of sub-inner_tv
         * @return the builder
         */
         ...
         * then synchronize this change to boom-button.
         *
         * @param subHighlightedTextColorRes color resource of sub-inner_tv
         * @return the builder
         */
        ...
        /**
         * Set the color of sub-inner_tv when boom-button is at unable-state.
         * <br><br>
         * <STRONG>Synchronicity:</STRONG> If the boom-button existed,
         * then synchronize this change to boom-button.
         *
         * @param subUnableTextColor color of sub-inner_tv
         * @return the builder
         */
         ...
         * then synchronize this change to boom-button.
         *
         * @param subUnableTextColorRes color resource of sub-inner_tv
         * @return the builder
         */
        ...
        /**
         * Set the rect of sub-inner_tv.
         * By this method, you can set the position and size of the sub-inner_tv-view in boom-button.
         * For example, builder.textRect(new Rect(0, 50, 100, 100)) will make the
         * sub-inner_tv-view's size to be 100 * 50 and margin-top to be 50 pixel.
         * <br><br>
         * <STRONG>Synchronicity:</STRONG> If the boom-button existed,
         * then synchronize this change to boom-button.
         *
         * @param subTextRect the sub-inner_tv rect, in pixel.
         * @return the builder
         */
        ...
        /**
         * Set the padding of sub-inner_tv.
         * By this method, you can control the padding in the sub-inner_tv-view.
         * For instance, builder.textPadding(new Rect(10, 10, 10, 10)) will make the
         * sub-inner_tv-view content 10-pixel padding to itself.
         * <br><br>
         * <STRONG>Synchronicity:</STRONG> If the boom-button existed,
         * then synchronize this change to boom-button.
         *
         * @param subTextPadding the sub-inner_tv padding
         * @return the builder
         */
        ...
        /**
         * Set the typeface of the sub-inner_tv.
         *
        ...
        /**
         * Set the maximum of the lines of sub-inner_tv-view.
         *
        ...
        /**
         * Set the gravity of sub-inner_tv-view.
         *
        ...
        /**
         * Set the ellipsize of the sub-inner_tv-view.
         *
        ...
        /**
         * Set the inner_tv size of the sub-inner_tv-view.
         *
         * @param subTextSize size of sub-inner_tv, in sp
         * @return the builder
         */
