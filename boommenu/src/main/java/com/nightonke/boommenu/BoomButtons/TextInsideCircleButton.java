...
public class TextInsideCircleButton extends BoomButton {
    ...
    public TextInsideCircleButton(Builder builder, Context context) {
        super(context);
...
//        image.setPivotY(buttonRadius - imageRect.top);}
        inner_tv.setPivotX(buttonRadius - textRect.left);
        inner_tv.setPivotY(buttonRadius - textRect.top);
    }
    ...
    public static class Builder extends BoomButtonWithTextBuilder<Builder> {
        ...
        public Builder goneImg(boolean isGone){
            isImgGone = isGone;
            return this;
        }
        ...
        /**
         * Build inner_tv-inside circle button, only use in BMB package.
         *
