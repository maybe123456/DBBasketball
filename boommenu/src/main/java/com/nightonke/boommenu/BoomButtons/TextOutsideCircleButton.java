...
//        if (rotateImage) rotateViews.add(image);
        if (rotateText) rotateViews.add(inner_tv);
        return rotateViews;
    }
...
//        image.setPivotY(buttonRadius - imageRect.top);
        inner_tv.setPivotX(trueRadius - textRect.left);
        inner_tv.setPivotY(trueRadius - textRect.top);
    }
    ...
    public static class Builder extends BoomButtonWithTextBuilder<Builder> {
        ...
        /**
         * Whether the inner_tv-view should rotate.
         *
        ...
        /**
         * Set the top-margin between inner_tv-view and the circle button.
         * Don't need to mind the shadow, BMB will mind this in code.
         *
         * @param textTopMargin top-margin between inner_tv-view and the circle button, bigger or
         *                      equal to zero.
         * @return the builder
         */
        ...
        /**
         * The width of inner_tv-view.
         *
         * @param textWidth width of inner_tv-view
         * @return the builder
         */
        ...
        /**
         * The height of inner_tv-view.
         *
         * @param textHeight height of inner_tv-view
         * @return the builder
         */
         ...
         *
         * @return the width of content in inner_tv-outside-circle-button
         */
         ...
         * don't use it outside.
         *
         * @return the height of content in inner_tv-outside-circle-button
         */
        ...
        /**
         * Build inner_tv-inside circle button, only used in BMB package.
         *
