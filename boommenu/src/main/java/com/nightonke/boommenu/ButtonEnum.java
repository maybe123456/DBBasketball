...
public enum ButtonEnum {
    ...
    /**
     * Boom-buttons which are circles with a inner_tv and image inside for each.
     */
    TextInsideCircle(1),

    /**
     * Boom-buttons which are circles with a inner_tv outside and image inside for each.
     */
    TextOutsideCircle(2),
