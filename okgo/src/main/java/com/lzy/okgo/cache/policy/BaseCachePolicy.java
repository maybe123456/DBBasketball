...
//      cacheEntity.isExpire();
        ...
        if (cacheEntity == null || cacheEntity.getData() == null || cacheEntity.getResponseHeaders() == null) {
            cacheEntity = null;
        }
        return cacheEntity;
    }
...
//                        Response<T> error = (T) e.toString();
            ...
            public void onResponse(okhttp3.Call call, okhttp3.Response response) throws IOException {
                ...
                try {
//                    Log.i("info","rawResponse3=="+response.message());
//                    Log.i("info","rawResponse4=="+response.body().string());
//                    T body = request.getConverter().convertResponse(response);

//                    if(response.body().string().contains("99")){
//                        T bdy = (T) response.body().string();
//                        Response<T> error = Response.error(false, call, response, HttpException.NO_DATA());
//                        onError(error);
//                    }else{
